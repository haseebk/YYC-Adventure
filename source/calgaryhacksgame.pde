...
void gameChooser() {
  ...
  image(stampede, width/1.35, height/9, 320, 200);
  image(calaway, width/9, height/9, 320, 200);
  image(nature, width/2.35, height/9, 320, 200);
  image(FN,width/9,height/1.4,320,200);
  
  
  //FN
  if (mouseX> width/9 && mouseX< width/9+320 && mouseY>height/1.4 && mouseY<height/1.4+200) {
    background(gameChooserBackground);
    image(FN, width/9, height/1.4 - height/25, 320, 200);
    textAlign(CENTER);


    strokeWeight(10);
    fill(255);
    rect(width/9, height/2.5, width/1.3, height/4, 50);
    fill(#fc583b);
    text("Explore Calgary First Nations", width/2, height/1.75);
    image(calaway, width/9, height/9, 320, 200);
    image(nature, width/2.35, height/9, 320, 200);
    image(exit, width-265, height-150, 215, 100); //exit button
    image(exit, width-265, height-175, 215, 100);
  ...
  //stampede
  if (mouseX> width/1.35 && mouseX< width/1.35+320 && mouseY>height/9 && mouseY<height/9+200) {
    background(gameChooserBackground);
    image(stampede, width/1.35, height/9 - height/25, 320, 200);
    textAlign(CENTER);


    strokeWeight(10);
    fill(255);
    rect(width/9, height/2, width/1.3, height/4, 50);
    fill(#fc583b);
    text("Play Cowboy Runner", width/2, height/1.5);
    image(calaway, width/9, height/9, 320, 200);
    image(nature, width/2.35, height/9, 320, 200);
    image(exit, width-265, height-150, 215, 100); //exit button
    image(exit, width-265, height-175, 215, 100);
  ...
  //nature
  if (mouseX> width/2.35 && mouseX< width/2.35+320 && mouseY>height/9 && mouseY<height/9+200) {
    background(gameChooserBackground);
    image(nature, width/2.35, height/9 - height/25, 320, 200);
    textAlign(CENTER);
    ...
    rect(width/9, height/2, width/1.3, height/4, 50);
    fill(#fc583b);
    text("Find Calgary Wildlife", width/2, height/1.5);
    image(calaway, width/9, height/9, 320, 200);
    image(stampede, width/1.35, height/9, 320, 200);
    image(exit, width-265, height-150, 215, 100); //exit button
    image(exit, width-265, height-175, 215, 100);
  ...
  if (mouseX> width/9 && mouseX< width/9+320 && mouseY>height/9 && mouseY<height/9+200) {
    ...
    rect(width/9, height/2, width/1.3, height/4, 50);
    fill(#fc583b);
    text("Play Calaway Whack-a-Mole", width/2, height/1.5);
    image(stampede, width/1.35, height/9, 320, 200);
    image(nature, width/2.35, height/9, 320, 200);
...
void wackAMoleEndScreen() {
  ...
  text("Time to Click = " +nf(wackAMoleLoseHealthTimer/1000.0, 0, 2) + "s", width/2, height/5+height/7+height/7);
...
void wackAMoleMousePressedEndScreen() {
...
void wackAMoleDraw() {
  ...
  //Middle
  image(wackAMoleMediumB, width/2, 6.1*height/7); 

  //top left
  image(wackAMoleSmallB, 5.61*width/19, 13.25*height/22);

  //top right
  image(wackAMoleSmallB, 13.34*width/19, 13.25*height/22); 

  //bottom left
  image(wackAMoleLargeB, 3*width/13, 8.5*height/9); 

  //bottom right
  image(wackAMoleLargeB, 10*width/13, 8.5*height/9); 

  switch (wackAMolePosition) {
  case 0: //Middle
    wackAMoleX= width/2;
    wackAMoleY= 5*height/7;
    image(wackAMoleMediumB, width/2, 5.35*height/7); 
    break;
  case 1: //top left
    wackAMoleX= 5.63*width/19;
    wackAMoleY= 11*height/22;
    image(wackAMoleSmallB, 5.61*width/19, 12.5*height/22);
    break;
  case 2: //top right
    wackAMoleX= 13.37*width/19;
    wackAMoleY= 11*height/22;
    image(wackAMoleSmallB, 13.34*width/19, 12.5*height/22); 
    break;
  case 3: //bottom left
    wackAMoleX= 3*width/13;
    wackAMoleY= 7*height/9;
    image(wackAMoleLargeB, 3*width/13, 7.4*height/9); 
    break;
  case 4: //bottom right
    wackAMoleX= 10*width/13;
    wackAMoleY= 7*height/9;
    image(wackAMoleLargeB, 10*width/13, 7.4*height/9); 
    break;
  }
  ...
  fill(55);
  textAlign(CENTER);
  text("Time to click = " +nf(wackAMoleLoseHealthTimer/1000.0, 0, 2) + "s", width/2, height/20);
...
void wackAMoleMousePressed() {
  ...
  if (wackAMoleX - wackAMoleDiameter * .5 <= mouseX && mouseX <= wackAMoleX + wackAMoleDiameter * .5 &&
    wackAMoleY - wackAMoleDiameter * .5 <= mouseY && mouseY <= wackAMoleY + wackAMoleDiameter * .5) {
...
void bullSetup() {
  ...
  GS.background.resize(int(width*1.55), 0);
